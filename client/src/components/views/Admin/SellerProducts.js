	...
	const renderItems = () =>
		...
		Products.map((product, index) => (
			<tr key={index}>
				...
				<td style={{ color: 'blue', fontStyle: 'bodered' }}>
					{product.sold} 개
				</td>
				<td style={{ color: 'red', fontStyle: 'bodered' }}>
					{product.price * product.sold} 원
				</td>
				<td>{product.description}</td>
				<td>
					<button onClick={() => removeItem(product._id)}>삭제</button>
				</td>
			</tr>
		));
							...
							<table>
								<thead>
									<tr>
										...
										<th>가격</th>
										<th>카테고리</th>
										<th style={{ color: 'blue', fontStyle: 'bodered' }}>
											판매개수
										</th>
										<th style={{ color: 'red', fontStyle: 'bodered' }}>
											판매실적
										</th>
										<th>설명</th>
										<th>삭제</th>
